...
for (const [rel,tokens] of [
  ['src/constructor/production/basisJson.ts',['BasisJsonScript','buildBasisJsonScript','serializeBasisJson','razmerno.basis-json.v1']],
...
console.log('Stage 16 BASIS/documents checks passed.')
