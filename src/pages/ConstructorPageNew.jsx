          ...
          <section className="cp-viewer-card">
            <div className="cp-viewer-toolbar cp-viewer-toolbar-simple">
              <div className="cp-viewer-title">
                <span>Вид</span>
                <strong>Выберите режим просмотра и масштаб модели</strong>
              </div>
              <div className="cp-viewer-actions cp-viewer-actions-target">
                <div className="cp-viewer-mode-switch" aria-label="Режим отображения">
                ...
                <button type="button" className="cp-viewer-auto-button" onClick={resetViewerView}>Авто</button>
                <div className="cp-viewer-zoom-control" aria-label="Масштаб модели">
            ...
            <div className="cp-viewer-tools cp-viewer-tools-target">
              <div className="cp-quick-actions cp-quick-actions-premium">
                <button type="button" onClick={addShelfToActiveSection}><span>+</span>Полка</button>
                <button type="button" onClick={addDrawerToActiveSection}><span>+</span>Ящик</button>
                <button type="button" onClick={toggleRailInActiveSection}><span>—</span>Штанга</button>
                <button type="button" className="danger" onClick={clearActiveSection}><span>×</span>Очистить</button>
              </div>
