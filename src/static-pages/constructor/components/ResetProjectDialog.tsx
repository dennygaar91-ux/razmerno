    ...
    >
      ...
      >
        ...
        <p id="rzm-3d-reset-dialog-description">
          Будут сброшены размеры, материалы, фасады, наполнение, секции и зоны.
          Контакты и условия заявки не удаляются. Действие нельзя отменить.
        </p>
        <ul>
          <li>Размеры и секции вернутся к значениям по умолчанию.</li>
          <li>Зоны, полки, ящики, штанги и фасады будут очищены.</li>
          <li>Контакты, доставка, сборка и согласие сохранятся.</li>
        </ul>
