...
export const RAZMERNO_PHASE_F_DECISIONS = {
  ...
  edge: 'Корпус — ABS 1 мм, фасады — ABS 2 мм, все стороны.',
...
export const RAZMERNO_MANUAL_BASIS_WORKFLOW = [
  ...
  'Нанести кромку по сторонам деталей согласно edge[]: корпус 1 мм по всем сторонам, фасады 2 мм по всем сторонам.',
