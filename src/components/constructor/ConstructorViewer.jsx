...
export default function ConstructorViewer({ project, renderCanvas, onZoneSelect }) {
  ...
  return (
    <section className="rp-ctor-card rp-ctor-viewer rp-ref-viewer rp-ref-viewer--expanded" aria-label="Предпросмотр шкафа">
      <ViewerToolbar />
      <ViewerScene sceneProps={sceneProps} renderCanvas={renderCanvas} onZoneSelect={onZoneSelect} />
    </section>
  )
}