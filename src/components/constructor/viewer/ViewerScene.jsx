...
export default function ViewerScene({ sceneProps, renderCanvas, onZoneSelect }) {
  ...
  return (
    <div className="rp-ref-scene rp-ref-scene--polished" data-viewer-scene="wardrobe" data-renderer={renderCanvas ? 'three' : 'css'} data-active-section={activeSection}>
      ...
      <div className="rp-ref-scene__hint">Нажмите на секцию шкафа, чтобы выбрать её</div>
    </div>
  )
}
