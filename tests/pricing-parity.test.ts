...
import { calculatePrice as calculateFrontendPrice } from "../src/shared/lib/price";
import { buildConstructorMaterialPricingContext } from "../src/pricing/materialPricing";
import { calculateDeliveryQuote, validateDelivery } from "../src/pricing/delivery";
...
import { initialState, makeCompatibleLayout, type ConfigState } from "../src/configurator/context";
import {
  pricingGoldenFixtures,
  pricingValidationFixtures,
  type PricingGoldenExpected,
  type PricingGoldenFixture,
} from "../src/pricing/pricingGoldenFixtures";
import type { CatalogPriceBreakdown } from "../src/pricing/engine";
...
console.log("");
console.log("Pricing parity tests:");
